...
#        sleep   2
        page should contain    ${customer_name}+${Random_string}
        table row should contain    id:ctl00_MainContent_orderGrid_ctl02_OrderSelector      1     ${customer_name}+${Random_string}
#        sleep    2
    END
